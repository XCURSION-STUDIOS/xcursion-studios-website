  ...
  return (
    <main className="page-body">
      <div style={{ position: 'relative', width: '100%', height: '75vh', minHeight: '500px', display: 'flex', alignItems: 'flex-end', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, backgroundImage: project.imageUrl ? `url(${project.imageUrl})` : undefined, background: project.imageUrl ? undefined : project.gradient }} />
