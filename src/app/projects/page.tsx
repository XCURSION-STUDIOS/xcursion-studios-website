      ...
      <div style={{ position: 'relative' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          {projects.map((p, i) => (
            ...
            >
              <div style={{ width: '96px', height: '64px', backgroundImage: p.imageUrl ? `url(${p.imageUrl})` : undefined, background: p.imageUrl ? undefined : 'var(--bg)', backgroundSize: 'cover', backgroundPosition: 'center', border: '1px solid var(--cream-faint)', flexShrink: 0 }} />
              <div>
